...
function Invoke-Pnpm {
  ...
  if (Test-Command "pnpm") {
    ...
    throw "pnpm or corepack pnpm is required. Install Node.js 22.12+ with corepack enabled, or install pnpm separately."
  }
...
if (-not (Test-Command "node")) {
  throw "Node.js 22.12+ is required. Install Node.js first."
}
...
if ($nodeVersion -lt $minimumNodeVersion) {
  throw "Node.js 22.12.0 or later is required. Current version: $nodeVersionText"
}
